...
% % Calculate distance
% r = pdist2(x, y);
% val=sqrt(2.0).*g1.*g2.*g3.^(1.0./4.0).*g4.^(1.0./4.0).*exp(-sqrt(6.0).*r.*sqrt(1.0./(g3+g4))).*(sqrt(6.0).*r.*sqrt(1.0./(g3+g4))+1.0).*sqrt(1.0./(g3+g4))
